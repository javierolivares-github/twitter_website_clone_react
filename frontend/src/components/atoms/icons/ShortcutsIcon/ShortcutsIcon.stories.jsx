...
/** The **ShortcutsIcon** component renders a shortcuts icon. */
export default {
  title: 'atoms/Icons/ShortcutsIcon',
  component: ShortcutsIcon,
  tags: ['autodocs'],
  argTypes: {
    fill: {
...
/** This is the default version of the **ShortcutsIcon** component:*/
